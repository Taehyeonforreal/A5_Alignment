...
@pytest.fixture
def model_id():
    # Original Stanford handout points at the Together cluster path
    # (/data/a5-alignment/models/Qwen2.5-Math-1.5B), which isn't accessible
    # outside the course. Use the public HF Hub id instead — same weights.
